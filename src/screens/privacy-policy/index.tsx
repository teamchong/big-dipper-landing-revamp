        ...
        <StyledSectionLimit>
          ...
          <ContentBox>
            ...
            <div className="indent">
              ...
              <Typography className="description">For the purposes of this Privacy Policy:</Typography>
              <ul>
                {definitions.map((x) => {
                  return (
            ...
            <div className="indent">
              ...
              <div className="indent-2">
                ...
                <Typography className="description">
                  ...
                  as You close Your web browser. You can learn more about cookies here:
